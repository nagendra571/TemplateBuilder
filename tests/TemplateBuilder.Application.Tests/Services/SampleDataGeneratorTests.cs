...
public class SampleDataGeneratorTests
{
    ...
    public async Task GenerateAsync_from_view_maps_column_types()
    {
        var gen = Create(ViewWith(
            new SqlColumnInfo("RecipientName", "nvarchar", MaxLength: 200),
            new SqlColumnInfo("Qty", "int"),
            new SqlColumnInfo("Amount", "decimal"),
            new SqlColumnInfo("DueDate", "datetime"),
            new SqlColumnInfo("IsActive", "bit"),
            new SqlColumnInfo("EmailAddress", "nvarchar", MaxLength: 100),
            new SqlColumnInfo("Id", "uniqueidentifier")));
    ...
    {
        var gen = Create(ViewWith(new SqlColumnInfo("FirstName", "nvarchar", MaxLength: 6)));
    ...
    {
        var gen = Create(ViewWith(new SqlColumnInfo("Qty", "int")));
